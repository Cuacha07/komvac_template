...
<section class="content">
    <div class="box box-primary">
        {!! Form::model($user, ['route' => ['CMS::users.update', $user->id], 'method' => 'PUT', 'files' => true]) !!}
            <div class="box-header">
                <h3 class="box-title"></h3>
                <div class="box-tools pull-right">
                    <a href="{{ route('CMS::users.index') }}" class="btn btn-default"><i class="fa fa-chevron-circle-left"></i> @lang('CMS::core.back')</a>
